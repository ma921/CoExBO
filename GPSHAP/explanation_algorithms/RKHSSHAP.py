...
from GPSHAP.gp_models.VariationalGPRegression import VariationalGPRegression
from GPSHAP.utils.shapley_procedure.preparing_weights_and_coalitions import compute_weights_and_coalitions
...
class RKHSSHAP(object):
    ...
    def __post_init__(self):
        ...
        if self.model.num_inducing_points is not None:
            ...
            self.model.num_inducing_points = self.train_X.shape[0]
